...
function createStyles(colors: ThemeColors, scaledFont: (n: number) => number) {
    return StyleSheet.create({
        ...
        cardSubtitle: { fontSize: scaledFont(12), color: colors.primary, fontWeight: '600', marginTop: 2 },
        cardMeta: { fontSize: scaledFont(13), color: colors.textSecondary, marginTop: 2 },
